...
class CrimeFragment : Fragment(), DatePickerFragment.Callbacks {
    ...
    private val model: CrimeDetailViewModel by lazy {
        val factory = CrimeViewModelFactory()
        ...
        model.crimeLiveData.observe(
            ...
            Observer { crime ->
                crime?.let {
                    ...
                    "com.ajsherrell.criminalintent.fileprovider",
                    photoFile)
                    updateUI()
                }
            }
    ...
    override fun onStart() {
        ...
        dateButton.setOnClickListener {
            DatePickerFragment.newInstance(crime.date).apply {
                ...
                show(this@CrimeFragment.requireFragmentManager(), DIALOG_DATE)  //depreciated but still works?
            }
        }
        ...
        reportButton.setOnClickListener {
            Intent(Intent.ACTION_SEND).apply {
                ...
                Log.d(TAG, "crime report = ${getCrimeReport()}!!!")
        ...
        suspectButton.apply {
            ...
            //check with OS if Contacts app is available, if not, disable the button.
    ...
    private fun updatePhotoView() {
        if (photoFile.exists()) {
            ...
            photoView.contentDescription = getString(R.string.photo)
        } else {
            photoView.setImageDrawable(null)
            photoView.contentDescription = getString(R.string.photo_no_photo)
        }
    }
